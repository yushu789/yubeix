...
val YubeixIcons.Th15: ImageVector
    get() = YubeixIcons.Regular.Th15

val YubeixIcons.Light.Th15: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -81.89999999999998f, translationY = 957.6f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(740.0f, 336.0f),
                        PathNode.LineTo(747.0f, 434.0f),
                        PathNode.HorizontalTo(873.0f),
                        PathNode.QuadTo(878.0f, 434.0f, 880.5f, 437.0f),
                        PathNode.QuadTo(883.0f, 440.0f, 883.0f, 444.0f),
                        PathNode.VerticalTo(467.0f),
                        PathNode.QuadTo(883.0f, 472.0f, 880.5f, 474.5f),
                        PathNode.QuadTo(878.0f, 477.0f, 873.0f, 477.0f),
                        PathNode.HorizontalTo(712.0f),
                        PathNode.QuadTo(702.0f, 477.0f, 702.0f, 468.0f),
                        PathNode.LineTo(690.0f, 306.0f),
                        PathNode.QuadTo(689.0f, 297.0f, 697.0f, 294.0f),
                        PathNode.LineTo(722.0f, 283.0f),
                        PathNode.QuadTo(730.0f, 278.0f, 735.0f, 287.0f),
                        PathNode.QuadTo(756.0f, 311.0f, 789.0f, 311.0f),
                        PathNode.QuadTo(818.0f, 311.0f, 836.0f, 293.5f),
                        PathNode.QuadTo(854.0f, 276.0f, 854.0f, 247.0f),
                        PathNode.QuadTo(854.0f, 219.0f, 836.0f, 201.5f),
                        PathNode.QuadTo(818.0f, 184.0f, 789.0f, 184.0f),
                        PathNode.QuadTo(746.0f, 184.0f, 724.0f, 224.0f),
                        PathNode.QuadTo(717.0f, 232.0f, 709.0f, 227.0f),
                        PathNode.LineTo(688.0f, 212.0f),
                        PathNode.QuadTo(684.0f, 210.0f, 683.0f, 206.0f),
                        PathNode.QuadTo(682.0f, 202.0f, 684.0f, 198.0f),
                        PathNode.QuadTo(698.0f, 171.0f, 725.0f, 156.0f),
                        PathNode.QuadTo(752.0f, 141.0f, 788.0f, 141.0f),
                        PathNode.QuadTo(840.0f, 141.0f, 870.5f, 170.5f),
                        PathNode.QuadTo(901.0f, 200.0f, 901.0f, 249.0f),
                        PathNode.QuadTo(901.0f, 296.0f, 873.0f, 325.0f),
                        PathNode.QuadTo(845.0f, 354.0f, 798.0f, 354.0f),
                        PathNode.QuadTo(764.0f, 354.0f, 740.0f, 336.0f),
                        PathNode.Close,
                    ),
...
val YubeixIcons.Regular.Th15: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -66.30000000000007f, translationY = 973.1999999999999f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(752.0f, 349.0f),
                        PathNode.LineTo(758.0f, 413.0f),
                        PathNode.HorizontalTo(879.0f),
                        PathNode.QuadTo(886.0f, 413.0f, 890.0f, 417.0f),
                        PathNode.QuadTo(894.0f, 421.0f, 894.0f, 428.0f),
                        PathNode.VerticalTo(464.0f),
                        PathNode.QuadTo(894.0f, 471.0f, 890.0f, 475.0f),
                        PathNode.QuadTo(886.0f, 479.0f, 879.0f, 479.0f),
                        PathNode.HorizontalTo(704.0f),
                        PathNode.QuadTo(690.0f, 479.0f, 689.0f, 465.0f),
                        PathNode.LineTo(677.0f, 306.0f),
                        PathNode.QuadTo(675.0f, 293.0f, 688.0f, 288.0f),
                        PathNode.LineTo(725.0f, 271.0f),
                        PathNode.QuadTo(737.0f, 265.0f, 745.0f, 277.0f),
                        PathNode.QuadTo(761.0f, 296.0f, 787.0f, 296.0f),
                        PathNode.QuadTo(811.0f, 296.0f, 825.0f, 283.0f),
                        PathNode.QuadTo(839.0f, 270.0f, 839.0f, 247.0f),
                        PathNode.QuadTo(839.0f, 225.0f, 825.0f, 212.0f),
                        PathNode.QuadTo(811.0f, 199.0f, 787.0f, 199.0f),
                        PathNode.QuadTo(755.0f, 199.0f, 737.0f, 228.0f),
                        PathNode.QuadTo(728.0f, 242.0f, 716.0f, 233.0f),
                        PathNode.LineTo(682.0f, 211.0f),
                        PathNode.QuadTo(677.0f, 207.0f, 675.0f, 202.0f),
                        PathNode.QuadTo(673.0f, 197.0f, 676.0f, 190.0f),
                        PathNode.QuadTo(692.0f, 163.0f, 720.5f, 148.0f),
                        PathNode.QuadTo(749.0f, 133.0f, 786.0f, 133.0f),
                        PathNode.QuadTo(844.0f, 133.0f, 877.5f, 164.0f),
                        PathNode.QuadTo(911.0f, 195.0f, 911.0f, 249.0f),
                        PathNode.QuadTo(911.0f, 300.0f, 881.5f, 330.5f),
                        PathNode.QuadTo(852.0f, 361.0f, 802.0f, 361.0f),
                        PathNode.QuadTo(775.0f, 361.0f, 752.0f, 349.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
val YubeixIcons.Heavy.Th15: ImageVector
    get() {
        if (_th15Heavy != null) return _th15Heavy!!
        _th15Heavy = ImageVector.Builder(
            name = "Th15.Heavy",
            defaultWidth = 24.0f.dp,
            defaultHeight = 24.0f.dp,
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -49.5f, translationY = 990.0f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(759.0f, 359.0f),
                        PathNode.LineTo(764.0f, 409.0f),
                        PathNode.HorizontalTo(874.0f),
                        PathNode.QuadTo(886.0f, 409.0f, 893.0f, 416.0f),
                        PathNode.QuadTo(900.0f, 423.0f, 900.0f, 434.0f),
                        PathNode.VerticalTo(460.0f),
                        PathNode.QuadTo(900.0f, 471.0f, 893.0f, 478.0f),
                        PathNode.QuadTo(886.0f, 485.0f, 874.0f, 485.0f),
                        PathNode.HorizontalTo(710.0f),
                        PathNode.QuadTo(685.0f, 485.0f, 683.0f, 461.0f),
                        PathNode.LineTo(672.0f, 313.0f),
                        PathNode.QuadTo(671.0f, 293.0f, 690.0f, 283.0f),
                        PathNode.LineTo(720.0f, 270.0f),
                        PathNode.QuadTo(737.0f, 262.0f, 753.0f, 278.0f),
                        PathNode.QuadTo(766.0f, 292.0f, 787.0f, 292.0f),
                        PathNode.QuadTo(809.0f, 292.0f, 821.0f, 281.0f),
                        PathNode.QuadTo(833.0f, 270.0f, 833.0f, 249.0f),
                        PathNode.QuadTo(833.0f, 230.0f, 820.5f, 218.5f),
                        PathNode.QuadTo(808.0f, 207.0f, 787.0f, 207.0f),
                        PathNode.QuadTo(762.0f, 207.0f, 745.0f, 229.0f),
                        PathNode.QuadTo(729.0f, 248.0f, 710.0f, 236.0f),
                        PathNode.LineTo(685.0f, 219.0f),
                        PathNode.QuadTo(675.0f, 213.0f, 672.5f, 203.5f),
                        PathNode.QuadTo(670.0f, 194.0f, 676.0f, 184.0f),
                        PathNode.QuadTo(692.0f, 158.0f, 721.0f, 144.0f),
                        PathNode.QuadTo(750.0f, 130.0f, 786.0f, 130.0f),
                        PathNode.QuadTo(846.0f, 130.0f, 881.5f, 162.5f),
                        PathNode.QuadTo(917.0f, 195.0f, 917.0f, 251.0f),
                        PathNode.QuadTo(917.0f, 304.0f, 886.5f, 336.0f),
                        PathNode.QuadTo(856.0f, 368.0f, 803.0f, 368.0f),
                        PathNode.QuadTo(780.0f, 368.0f, 759.0f, 359.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
private var _th15Heavy: ImageVector? = null
