...
val YubeixIcons.Th10: ImageVector
    get() = YubeixIcons.Regular.Th10

val YubeixIcons.Light.Th10: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -81.89999999999998f, translationY = 957.6f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(906.0f, 312.0f),
                        PathNode.QuadTo(906.0f, 395.0f, 876.0f, 439.0f),
                        PathNode.QuadTo(846.0f, 483.0f, 790.0f, 483.0f),
                        PathNode.QuadTo(733.0f, 483.0f, 703.0f, 439.5f),
                        PathNode.QuadTo(673.0f, 396.0f, 673.0f, 312.0f),
                        PathNode.QuadTo(673.0f, 228.0f, 703.0f, 184.5f),
                        PathNode.QuadTo(733.0f, 141.0f, 790.0f, 141.0f),
                        PathNode.QuadTo(846.0f, 141.0f, 876.0f, 185.0f),
                        PathNode.QuadTo(906.0f, 229.0f, 906.0f, 312.0f),
                        PathNode.Close,
                        PathNode.MoveTo(723.0f, 312.0f),
                        PathNode.QuadTo(723.0f, 374.0f, 740.5f, 406.0f),
                        PathNode.QuadTo(758.0f, 438.0f, 790.0f, 438.0f),
                        PathNode.QuadTo(822.0f, 438.0f, 839.5f, 406.0f),
                        PathNode.QuadTo(857.0f, 374.0f, 857.0f, 312.0f),
                        PathNode.QuadTo(857.0f, 250.0f, 839.5f, 218.0f),
                        PathNode.QuadTo(822.0f, 186.0f, 790.0f, 186.0f),
                        PathNode.QuadTo(758.0f, 186.0f, 740.5f, 218.0f),
                        PathNode.QuadTo(723.0f, 250.0f, 723.0f, 312.0f),
                        PathNode.Close,
                        PathNode.MoveTo(516.0f, 147.0f),
                        PathNode.HorizontalTo(544.0f),
                        PathNode.QuadTo(549.0f, 147.0f, 551.5f, 150.0f),
                        PathNode.QuadTo(554.0f, 153.0f, 554.0f, 157.0f),
                        PathNode.VerticalTo(467.0f),
                        PathNode.QuadTo(554.0f, 472.0f, 551.5f, 474.5f),
                        PathNode.QuadTo(549.0f, 477.0f, 544.0f, 477.0f),
                        PathNode.HorizontalTo(522.0f),
                        PathNode.QuadTo(513.0f, 477.0f, 509.0f, 475.0f),
                        PathNode.LineTo(442.0f, 439.0f),
                        PathNode.QuadTo(435.0f, 435.0f, 435.0f, 427.0f),
                        PathNode.VerticalTo(398.0f),
                        PathNode.QuadTo(435.0f, 393.0f, 438.5f, 390.5f),
                        PathNode.QuadTo(442.0f, 388.0f, 447.0f, 391.0f),
                        PathNode.LineTo(506.0f, 422.0f),
                        PathNode.VerticalTo(157.0f),
                        PathNode.QuadTo(506.0f, 153.0f, 509.0f, 150.0f),
                        PathNode.QuadTo(512.0f, 147.0f, 516.0f, 147.0f),
                        PathNode.Close,
                    ),
...
val YubeixIcons.Regular.Th10: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -66.30000000000007f, translationY = 973.1999999999999f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(918.0f, 309.0f),
                        PathNode.QuadTo(918.0f, 395.0f, 885.5f, 439.5f),
                        PathNode.QuadTo(853.0f, 484.0f, 791.0f, 484.0f),
                        PathNode.QuadTo(730.0f, 484.0f, 697.0f, 439.5f),
                        PathNode.QuadTo(664.0f, 395.0f, 664.0f, 309.0f),
                        PathNode.QuadTo(664.0f, 223.0f, 697.0f, 178.0f),
                        PathNode.QuadTo(730.0f, 133.0f, 791.0f, 133.0f),
                        PathNode.QuadTo(853.0f, 133.0f, 885.5f, 177.5f),
                        PathNode.QuadTo(918.0f, 222.0f, 918.0f, 309.0f),
                        PathNode.Close,
                        PathNode.MoveTo(739.0f, 309.0f),
                        PathNode.QuadTo(739.0f, 362.0f, 752.5f, 389.0f),
                        PathNode.QuadTo(766.0f, 416.0f, 791.0f, 416.0f),
                        PathNode.QuadTo(817.0f, 416.0f, 830.5f, 389.0f),
                        PathNode.QuadTo(844.0f, 362.0f, 844.0f, 309.0f),
                        PathNode.QuadTo(844.0f, 256.0f, 830.5f, 228.5f),
                        PathNode.QuadTo(817.0f, 201.0f, 791.0f, 201.0f),
                        PathNode.QuadTo(766.0f, 201.0f, 752.5f, 228.5f),
                        PathNode.QuadTo(739.0f, 256.0f, 739.0f, 309.0f),
                        PathNode.Close,
                        PathNode.MoveTo(510.0f, 139.0f),
                        PathNode.HorizontalTo(553.0f),
                        PathNode.QuadTo(560.0f, 139.0f, 564.0f, 143.0f),
                        PathNode.QuadTo(568.0f, 147.0f, 568.0f, 154.0f),
                        PathNode.VerticalTo(464.0f),
                        PathNode.QuadTo(568.0f, 471.0f, 564.0f, 475.0f),
                        PathNode.QuadTo(560.0f, 479.0f, 553.0f, 479.0f),
                        PathNode.HorizontalTo(518.0f),
                        PathNode.QuadTo(507.0f, 479.0f, 499.0f, 475.0f),
                        PathNode.LineTo(431.0f, 440.0f),
                        PathNode.QuadTo(420.0f, 434.0f, 420.0f, 422.0f),
                        PathNode.VerticalTo(378.0f),
                        PathNode.QuadTo(420.0f, 369.0f, 425.0f, 366.0f),
                        PathNode.QuadTo(430.0f, 363.0f, 438.0f, 367.0f),
                        PathNode.LineTo(495.0f, 397.0f),
                        PathNode.VerticalTo(154.0f),
                        PathNode.QuadTo(495.0f, 147.0f, 499.0f, 143.0f),
                        PathNode.QuadTo(503.0f, 139.0f, 510.0f, 139.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
val YubeixIcons.Heavy.Th10: ImageVector
    get() {
        if (_th10Heavy != null) return _th10Heavy!!
        _th10Heavy = ImageVector.Builder(
            name = "Th10.Heavy",
            defaultWidth = 24.0f.dp,
            defaultHeight = 24.0f.dp,
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -49.5f, translationY = 990.0f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(923.0f, 311.0f),
                        PathNode.QuadTo(923.0f, 399.0f, 889.0f, 445.0f),
                        PathNode.QuadTo(855.0f, 491.0f, 791.0f, 491.0f),
                        PathNode.QuadTo(727.0f, 491.0f, 692.5f, 445.0f),
                        PathNode.QuadTo(658.0f, 399.0f, 658.0f, 311.0f),
                        PathNode.QuadTo(658.0f, 223.0f, 692.5f, 177.0f),
                        PathNode.QuadTo(727.0f, 131.0f, 791.0f, 131.0f),
                        PathNode.QuadTo(855.0f, 131.0f, 889.0f, 177.0f),
                        PathNode.QuadTo(923.0f, 223.0f, 923.0f, 311.0f),
                        PathNode.Close,
                        PathNode.MoveTo(744.0f, 311.0f),
                        PathNode.QuadTo(744.0f, 362.0f, 756.5f, 387.0f),
                        PathNode.QuadTo(769.0f, 412.0f, 791.0f, 412.0f),
                        PathNode.QuadTo(813.0f, 412.0f, 825.5f, 387.0f),
                        PathNode.QuadTo(838.0f, 362.0f, 838.0f, 311.0f),
                        PathNode.QuadTo(838.0f, 260.0f, 825.5f, 235.0f),
                        PathNode.QuadTo(813.0f, 210.0f, 791.0f, 210.0f),
                        PathNode.QuadTo(769.0f, 210.0f, 756.5f, 235.0f),
                        PathNode.QuadTo(744.0f, 260.0f, 744.0f, 311.0f),
                        PathNode.Close,
                        PathNode.MoveTo(510.0f, 137.0f),
                        PathNode.HorizontalTo(550.0f),
                        PathNode.QuadTo(560.0f, 137.0f, 566.0f, 143.0f),
                        PathNode.QuadTo(572.0f, 149.0f, 572.0f, 159.0f),
                        PathNode.VerticalTo(464.0f),
                        PathNode.QuadTo(572.0f, 474.0f, 566.0f, 480.0f),
                        PathNode.QuadTo(560.0f, 486.0f, 550.0f, 486.0f),
                        PathNode.HorizontalTo(518.0f),
                        PathNode.QuadTo(504.0f, 486.0f, 490.0f, 480.0f),
                        PathNode.LineTo(427.0f, 447.0f),
                        PathNode.QuadTo(411.0f, 440.0f, 411.0f, 421.0f),
                        PathNode.VerticalTo(380.0f),
                        PathNode.QuadTo(411.0f, 367.0f, 418.5f, 362.0f),
                        PathNode.QuadTo(426.0f, 357.0f, 437.0f, 364.0f),
                        PathNode.LineTo(488.0f, 391.0f),
                        PathNode.VerticalTo(159.0f),
                        PathNode.QuadTo(488.0f, 149.0f, 494.0f, 143.0f),
                        PathNode.QuadTo(500.0f, 137.0f, 510.0f, 137.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
private var _th10Heavy: ImageVector? = null
