...
val YubeixIcons.Th2: ImageVector
    get() = YubeixIcons.Regular.Th2

val YubeixIcons.Light.Th2: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -81.89999999999998f, translationY = 957.6f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(767.0f, 389.0f),
                        PathNode.QuadTo(767.0f, 431.0f, 739.0f, 457.0f),
                        PathNode.QuadTo(711.0f, 483.0f, 664.0f, 483.0f),
                        PathNode.QuadTo(628.0f, 483.0f, 601.5f, 466.5f),
                        PathNode.QuadTo(575.0f, 450.0f, 562.0f, 422.0f),
                        PathNode.QuadTo(560.0f, 418.0f, 560.5f, 415.0f),
                        PathNode.QuadTo(561.0f, 412.0f, 565.0f, 408.0f),
                        PathNode.LineTo(586.0f, 394.0f),
                        PathNode.QuadTo(590.0f, 391.0f, 594.0f, 392.0f),
                        PathNode.QuadTo(598.0f, 393.0f, 600.0f, 397.0f),
                        PathNode.QuadTo(621.0f, 438.0f, 663.0f, 438.0f),
                        PathNode.QuadTo(688.0f, 438.0f, 703.5f, 424.0f),
                        PathNode.QuadTo(719.0f, 410.0f, 719.0f, 386.0f),
                        PathNode.QuadTo(719.0f, 368.0f, 709.5f, 351.0f),
                        PathNode.QuadTo(700.0f, 334.0f, 677.0f, 310.0f),
                        PathNode.LineTo(562.0f, 186.0f),
                        PathNode.QuadTo(557.0f, 179.0f, 557.0f, 173.0f),
                        PathNode.VerticalTo(157.0f),
                        PathNode.QuadTo(557.0f, 153.0f, 560.0f, 149.5f),
                        PathNode.QuadTo(563.0f, 146.0f, 567.0f, 146.0f),
                        PathNode.HorizontalTo(763.0f),
                        PathNode.QuadTo(767.0f, 146.0f, 770.0f, 149.0f),
                        PathNode.QuadTo(773.0f, 152.0f, 773.0f, 157.0f),
                        PathNode.VerticalTo(181.0f),
                        PathNode.QuadTo(773.0f, 186.0f, 770.5f, 188.5f),
                        PathNode.QuadTo(768.0f, 191.0f, 763.0f, 191.0f),
                        PathNode.HorizontalTo(629.0f),
                        PathNode.LineTo(716.0f, 286.0f),
                        PathNode.QuadTo(743.0f, 314.0f, 755.0f, 337.5f),
                        PathNode.QuadTo(767.0f, 361.0f, 767.0f, 389.0f),
                        PathNode.Close,
                    ),
...
val YubeixIcons.Regular.Th2: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -66.30000000000007f, translationY = 973.1999999999999f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(777.0f, 381.0f),
                        PathNode.QuadTo(777.0f, 427.0f, 747.0f, 455.5f),
                        PathNode.QuadTo(717.0f, 484.0f, 664.0f, 484.0f),
                        PathNode.QuadTo(624.0f, 484.0f, 596.5f, 467.0f),
                        PathNode.QuadTo(569.0f, 450.0f, 554.0f, 423.0f),
                        PathNode.QuadTo(551.0f, 417.0f, 552.0f, 412.0f),
                        PathNode.QuadTo(553.0f, 407.0f, 559.0f, 403.0f),
                        PathNode.LineTo(591.0f, 381.0f),
                        PathNode.QuadTo(597.0f, 377.0f, 602.0f, 378.0f),
                        PathNode.QuadTo(607.0f, 379.0f, 611.0f, 386.0f),
                        PathNode.QuadTo(631.0f, 417.0f, 662.0f, 417.0f),
                        PathNode.QuadTo(681.0f, 417.0f, 692.0f, 406.0f),
                        PathNode.QuadTo(703.0f, 395.0f, 703.0f, 377.0f),
                        PathNode.QuadTo(703.0f, 362.0f, 695.0f, 347.5f),
                        PathNode.QuadTo(687.0f, 333.0f, 667.0f, 312.0f),
                        PathNode.LineTo(555.0f, 196.0f),
                        PathNode.QuadTo(548.0f, 188.0f, 548.0f, 177.0f),
                        PathNode.VerticalTo(153.0f),
                        PathNode.QuadTo(548.0f, 146.0f, 552.0f, 142.0f),
                        PathNode.QuadTo(556.0f, 138.0f, 563.0f, 138.0f),
                        PathNode.HorizontalTo(769.0f),
                        PathNode.QuadTo(776.0f, 138.0f, 780.0f, 142.0f),
                        PathNode.QuadTo(784.0f, 146.0f, 784.0f, 153.0f),
                        PathNode.VerticalTo(191.0f),
                        PathNode.QuadTo(784.0f, 198.0f, 780.0f, 202.0f),
                        PathNode.QuadTo(776.0f, 206.0f, 769.0f, 206.0f),
                        PathNode.HorizontalTo(659.0f),
                        PathNode.LineTo(725.0f, 276.0f),
                        PathNode.QuadTo(751.0f, 303.0f, 764.0f, 328.0f),
                        PathNode.QuadTo(777.0f, 353.0f, 777.0f, 381.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
val YubeixIcons.Heavy.Th2: ImageVector
    get() {
        if (_th2Heavy != null) return _th2Heavy!!
        _th2Heavy = ImageVector.Builder(
            name = "Th2.Heavy",
            defaultWidth = 24.0f.dp,
            defaultHeight = 24.0f.dp,
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -49.5f, translationY = 990.0f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(782.0f, 383.0f),
                        PathNode.QuadTo(782.0f, 432.0f, 750.5f, 461.5f),
                        PathNode.QuadTo(719.0f, 491.0f, 664.0f, 491.0f),
                        PathNode.QuadTo(623.0f, 491.0f, 594.5f, 474.0f),
                        PathNode.QuadTo(566.0f, 457.0f, 550.0f, 430.0f),
                        PathNode.QuadTo(545.0f, 421.0f, 547.0f, 414.0f),
                        PathNode.QuadTo(549.0f, 407.0f, 558.0f, 400.0f),
                        PathNode.LineTo(588.0f, 380.0f),
                        PathNode.QuadTo(597.0f, 374.0f, 604.0f, 376.0f),
                        PathNode.QuadTo(611.0f, 378.0f, 617.0f, 388.0f),
                        PathNode.QuadTo(634.0f, 414.0f, 662.0f, 414.0f),
                        PathNode.QuadTo(678.0f, 414.0f, 687.5f, 404.5f),
                        PathNode.QuadTo(697.0f, 395.0f, 697.0f, 379.0f),
                        PathNode.QuadTo(697.0f, 365.0f, 689.5f, 351.5f),
                        PathNode.QuadTo(682.0f, 338.0f, 664.0f, 319.0f),
                        PathNode.LineTo(553.0f, 204.0f),
                        PathNode.QuadTo(542.0f, 193.0f, 542.0f, 177.0f),
                        PathNode.VerticalTo(158.0f),
                        PathNode.QuadTo(542.0f, 148.0f, 548.0f, 142.0f),
                        PathNode.QuadTo(554.0f, 136.0f, 564.0f, 136.0f),
                        PathNode.HorizontalTo(767.0f),
                        PathNode.QuadTo(778.0f, 136.0f, 783.5f, 142.0f),
                        PathNode.QuadTo(789.0f, 148.0f, 789.0f, 158.0f),
                        PathNode.VerticalTo(193.0f),
                        PathNode.QuadTo(789.0f, 204.0f, 783.5f, 209.5f),
                        PathNode.QuadTo(778.0f, 215.0f, 767.0f, 215.0f),
                        PathNode.HorizontalTo(672.0f),
                        PathNode.LineTo(730.0f, 276.0f),
                        PathNode.QuadTo(755.0f, 302.0f, 768.5f, 328.0f),
                        PathNode.QuadTo(782.0f, 354.0f, 782.0f, 383.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
private var _th2Heavy: ImageVector? = null
