...
val YubeixIcons.Th12: ImageVector
    get() = YubeixIcons.Regular.Th12

val YubeixIcons.Light.Th12: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -81.89999999999998f, translationY = 957.6f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(896.0f, 389.0f),
                        PathNode.QuadTo(896.0f, 431.0f, 867.5f, 457.0f),
                        PathNode.QuadTo(839.0f, 483.0f, 793.0f, 483.0f),
                        PathNode.QuadTo(756.0f, 483.0f, 729.5f, 466.5f),
                        PathNode.QuadTo(703.0f, 450.0f, 690.0f, 422.0f),
                        PathNode.QuadTo(688.0f, 418.0f, 688.5f, 415.0f),
                        PathNode.QuadTo(689.0f, 412.0f, 694.0f, 408.0f),
                        PathNode.LineTo(715.0f, 394.0f),
                        PathNode.QuadTo(723.0f, 387.0f, 728.0f, 397.0f),
                        PathNode.QuadTo(749.0f, 438.0f, 792.0f, 438.0f),
                        PathNode.QuadTo(816.0f, 438.0f, 831.5f, 424.0f),
                        PathNode.QuadTo(847.0f, 410.0f, 847.0f, 386.0f),
                        PathNode.QuadTo(847.0f, 368.0f, 837.5f, 351.0f),
                        PathNode.QuadTo(828.0f, 334.0f, 806.0f, 310.0f),
                        PathNode.LineTo(691.0f, 186.0f),
                        PathNode.QuadTo(686.0f, 181.0f, 686.0f, 173.0f),
                        PathNode.VerticalTo(157.0f),
                        PathNode.QuadTo(686.0f, 152.0f, 689.0f, 149.0f),
                        PathNode.QuadTo(692.0f, 146.0f, 696.0f, 146.0f),
                        PathNode.HorizontalTo(892.0f),
                        PathNode.QuadTo(896.0f, 146.0f, 899.0f, 149.0f),
                        PathNode.QuadTo(902.0f, 152.0f, 902.0f, 157.0f),
                        PathNode.VerticalTo(181.0f),
                        PathNode.QuadTo(902.0f, 186.0f, 899.5f, 188.5f),
                        PathNode.QuadTo(897.0f, 191.0f, 892.0f, 191.0f),
                        PathNode.HorizontalTo(758.0f),
                        PathNode.LineTo(845.0f, 286.0f),
                        PathNode.QuadTo(872.0f, 315.0f, 884.0f, 338.0f),
                        PathNode.QuadTo(896.0f, 361.0f, 896.0f, 389.0f),
                        PathNode.Close,
                    ),
...
val YubeixIcons.Regular.Th12: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -66.30000000000007f, translationY = 973.1999999999999f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(905.0f, 381.0f),
                        PathNode.QuadTo(905.0f, 427.0f, 875.0f, 455.5f),
                        PathNode.QuadTo(845.0f, 484.0f, 792.0f, 484.0f),
                        PathNode.QuadTo(752.0f, 484.0f, 724.5f, 467.0f),
                        PathNode.QuadTo(697.0f, 450.0f, 682.0f, 423.0f),
                        PathNode.QuadTo(679.0f, 417.0f, 680.0f, 412.0f),
                        PathNode.QuadTo(681.0f, 407.0f, 687.0f, 403.0f),
                        PathNode.LineTo(719.0f, 381.0f),
                        PathNode.QuadTo(731.0f, 372.0f, 739.0f, 386.0f),
                        PathNode.QuadTo(759.0f, 417.0f, 790.0f, 417.0f),
                        PathNode.QuadTo(809.0f, 417.0f, 820.0f, 406.0f),
                        PathNode.QuadTo(831.0f, 395.0f, 831.0f, 377.0f),
                        PathNode.QuadTo(831.0f, 362.0f, 823.0f, 347.5f),
                        PathNode.QuadTo(815.0f, 333.0f, 795.0f, 312.0f),
                        PathNode.LineTo(683.0f, 196.0f),
                        PathNode.QuadTo(676.0f, 188.0f, 676.0f, 177.0f),
                        PathNode.VerticalTo(153.0f),
                        PathNode.QuadTo(676.0f, 146.0f, 680.0f, 142.0f),
                        PathNode.QuadTo(684.0f, 138.0f, 691.0f, 138.0f),
                        PathNode.HorizontalTo(897.0f),
                        PathNode.QuadTo(904.0f, 138.0f, 908.0f, 142.0f),
                        PathNode.QuadTo(912.0f, 146.0f, 912.0f, 153.0f),
                        PathNode.VerticalTo(191.0f),
                        PathNode.QuadTo(912.0f, 198.0f, 908.0f, 202.0f),
                        PathNode.QuadTo(904.0f, 206.0f, 897.0f, 206.0f),
                        PathNode.HorizontalTo(787.0f),
                        PathNode.LineTo(853.0f, 276.0f),
                        PathNode.QuadTo(879.0f, 303.0f, 892.0f, 328.0f),
                        PathNode.QuadTo(905.0f, 353.0f, 905.0f, 381.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
val YubeixIcons.Heavy.Th12: ImageVector
    get() {
        if (_th12Heavy != null) return _th12Heavy!!
        _th12Heavy = ImageVector.Builder(
            name = "Th12.Heavy",
            defaultWidth = 24.0f.dp,
            defaultHeight = 24.0f.dp,
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -49.5f, translationY = 990.0f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(909.0f, 383.0f),
                        PathNode.QuadTo(909.0f, 432.0f, 877.5f, 461.5f),
                        PathNode.QuadTo(846.0f, 491.0f, 791.0f, 491.0f),
                        PathNode.QuadTo(750.0f, 491.0f, 721.5f, 474.0f),
                        PathNode.QuadTo(693.0f, 457.0f, 677.0f, 430.0f),
                        PathNode.QuadTo(672.0f, 421.0f, 674.0f, 414.0f),
                        PathNode.QuadTo(676.0f, 407.0f, 685.0f, 400.0f),
                        PathNode.LineTo(715.0f, 380.0f),
                        PathNode.QuadTo(732.0f, 369.0f, 744.0f, 388.0f),
                        PathNode.QuadTo(761.0f, 414.0f, 789.0f, 414.0f),
                        PathNode.QuadTo(805.0f, 414.0f, 814.5f, 404.5f),
                        PathNode.QuadTo(824.0f, 395.0f, 824.0f, 379.0f),
                        PathNode.QuadTo(824.0f, 365.0f, 816.5f, 351.5f),
                        PathNode.QuadTo(809.0f, 338.0f, 791.0f, 319.0f),
                        PathNode.LineTo(680.0f, 204.0f),
                        PathNode.QuadTo(669.0f, 193.0f, 669.0f, 177.0f),
                        PathNode.VerticalTo(158.0f),
                        PathNode.QuadTo(669.0f, 148.0f, 675.0f, 142.0f),
                        PathNode.QuadTo(681.0f, 136.0f, 691.0f, 136.0f),
                        PathNode.HorizontalTo(894.0f),
                        PathNode.QuadTo(905.0f, 136.0f, 910.5f, 142.0f),
                        PathNode.QuadTo(916.0f, 148.0f, 916.0f, 158.0f),
                        PathNode.VerticalTo(193.0f),
                        PathNode.QuadTo(916.0f, 204.0f, 910.5f, 209.5f),
                        PathNode.QuadTo(905.0f, 215.0f, 894.0f, 215.0f),
                        PathNode.HorizontalTo(799.0f),
                        PathNode.LineTo(857.0f, 276.0f),
                        PathNode.QuadTo(882.0f, 302.0f, 895.5f, 328.0f),
                        PathNode.QuadTo(909.0f, 354.0f, 909.0f, 383.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
private var _th12Heavy: ImageVector? = null
