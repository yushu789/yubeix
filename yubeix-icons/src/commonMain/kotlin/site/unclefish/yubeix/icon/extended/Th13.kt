...
val YubeixIcons.Th13: ImageVector
    get() = YubeixIcons.Regular.Th13

val YubeixIcons.Light.Th13: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -81.89999999999998f, translationY = 957.6f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(792.0f, 344.0f),
                        PathNode.LineTo(881.0f, 432.0f),
                        PathNode.QuadTo(886.0f, 437.0f, 886.0f, 445.0f),
                        PathNode.VerticalTo(467.0f),
                        PathNode.QuadTo(886.0f, 472.0f, 883.5f, 474.5f),
                        PathNode.QuadTo(881.0f, 477.0f, 876.0f, 477.0f),
                        PathNode.HorizontalTo(702.0f),
                        PathNode.QuadTo(698.0f, 477.0f, 695.0f, 474.5f),
                        PathNode.QuadTo(692.0f, 472.0f, 692.0f, 467.0f),
                        PathNode.VerticalTo(443.0f),
                        PathNode.QuadTo(692.0f, 439.0f, 695.0f, 436.0f),
                        PathNode.QuadTo(698.0f, 433.0f, 702.0f, 433.0f),
                        PathNode.HorizontalTo(823.0f),
                        PathNode.LineTo(732.0f, 338.0f),
                        PathNode.QuadTo(726.0f, 332.0f, 731.0f, 323.0f),
                        PathNode.LineTo(746.0f, 304.0f),
                        PathNode.QuadTo(750.0f, 297.0f, 760.0f, 302.0f),
                        PathNode.QuadTo(774.0f, 309.0f, 792.0f, 309.0f),
                        PathNode.QuadTo(819.0f, 309.0f, 837.0f, 291.5f),
                        PathNode.QuadTo(855.0f, 274.0f, 855.0f, 246.0f),
                        PathNode.QuadTo(855.0f, 218.0f, 837.5f, 201.5f),
                        PathNode.QuadTo(820.0f, 185.0f, 792.0f, 185.0f),
                        PathNode.QuadTo(749.0f, 185.0f, 724.0f, 226.0f),
                        PathNode.QuadTo(722.0f, 231.0f, 718.5f, 232.0f),
                        PathNode.QuadTo(715.0f, 233.0f, 711.0f, 229.0f),
                        PathNode.LineTo(690.0f, 214.0f),
                        PathNode.QuadTo(686.0f, 212.0f, 685.0f, 208.5f),
                        PathNode.QuadTo(684.0f, 205.0f, 686.0f, 201.0f),
                        PathNode.QuadTo(702.0f, 173.0f, 728.5f, 157.0f),
                        PathNode.QuadTo(755.0f, 141.0f, 792.0f, 141.0f),
                        PathNode.QuadTo(841.0f, 141.0f, 871.5f, 170.0f),
                        PathNode.QuadTo(902.0f, 199.0f, 902.0f, 246.0f),
                        PathNode.QuadTo(902.0f, 278.0f, 886.5f, 302.0f),
                        PathNode.QuadTo(871.0f, 326.0f, 845.5f, 336.5f),
                        PathNode.QuadTo(820.0f, 347.0f, 793.0f, 342.0f),
                        PathNode.Close,
                    ),
...
val YubeixIcons.Regular.Th13: ImageVector
    get() {
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -66.30000000000007f, translationY = 973.1999999999999f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(814.0f, 349.0f),
                        PathNode.LineTo(886.0f, 412.0f),
                        PathNode.QuadTo(894.0f, 419.0f, 894.0f, 430.0f),
                        PathNode.VerticalTo(464.0f),
                        PathNode.QuadTo(894.0f, 471.0f, 890.0f, 475.0f),
                        PathNode.QuadTo(886.0f, 479.0f, 879.0f, 479.0f),
                        PathNode.HorizontalTo(699.0f),
                        PathNode.QuadTo(692.0f, 479.0f, 688.0f, 475.0f),
                        PathNode.QuadTo(684.0f, 471.0f, 684.0f, 464.0f),
                        PathNode.VerticalTo(426.0f),
                        PathNode.QuadTo(684.0f, 419.0f, 688.0f, 415.0f),
                        PathNode.QuadTo(692.0f, 411.0f, 699.0f, 411.0f),
                        PathNode.HorizontalTo(797.0f),
                        PathNode.LineTo(727.0f, 344.0f),
                        PathNode.QuadTo(717.0f, 334.0f, 726.0f, 323.0f),
                        PathNode.LineTo(748.0f, 294.0f),
                        PathNode.QuadTo(756.0f, 283.0f, 769.0f, 290.0f),
                        PathNode.QuadTo(778.0f, 294.0f, 790.0f, 294.0f),
                        PathNode.QuadTo(812.0f, 293.0f, 825.0f, 280.5f),
                        PathNode.QuadTo(838.0f, 268.0f, 838.0f, 246.0f),
                        PathNode.QuadTo(838.0f, 224.0f, 824.5f, 211.5f),
                        PathNode.QuadTo(811.0f, 199.0f, 789.0f, 199.0f),
                        PathNode.QuadTo(757.0f, 199.0f, 736.0f, 231.0f),
                        PathNode.QuadTo(732.0f, 238.0f, 727.0f, 239.0f),
                        PathNode.QuadTo(722.0f, 240.0f, 716.0f, 236.0f),
                        PathNode.LineTo(684.0f, 214.0f),
                        PathNode.QuadTo(679.0f, 210.0f, 677.0f, 205.0f),
                        PathNode.QuadTo(675.0f, 200.0f, 678.0f, 194.0f),
                        PathNode.QuadTo(695.0f, 166.0f, 723.0f, 149.5f),
                        PathNode.QuadTo(751.0f, 133.0f, 790.0f, 133.0f),
                        PathNode.QuadTo(843.0f, 133.0f, 876.5f, 164.5f),
                        PathNode.QuadTo(910.0f, 196.0f, 910.0f, 246.0f),
                        PathNode.QuadTo(910.0f, 276.0f, 897.0f, 299.5f),
                        PathNode.QuadTo(884.0f, 323.0f, 862.0f, 335.5f),
                        PathNode.QuadTo(840.0f, 348.0f, 814.0f, 347.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
val YubeixIcons.Heavy.Th13: ImageVector
    get() {
        if (_th13Heavy != null) return _th13Heavy!!
        _th13Heavy = ImageVector.Builder(
            name = "Th13.Heavy",
            defaultWidth = 24.0f.dp,
            defaultHeight = 24.0f.dp,
            ...
            group(scaleX = 1.0f, scaleY = -1.0f, translationX = -49.5f, translationY = 990.0f) {
                addPath(
                    pathData = listOf(
                        ...
                        PathNode.Close,
                        PathNode.MoveTo(827.0f, 355.0f),
                        PathNode.LineTo(888.0f, 407.0f),
                        PathNode.QuadTo(901.0f, 417.0f, 901.0f, 434.0f),
                        PathNode.VerticalTo(464.0f),
                        PathNode.QuadTo(901.0f, 474.0f, 895.0f, 479.5f),
                        PathNode.QuadTo(889.0f, 485.0f, 879.0f, 485.0f),
                        PathNode.HorizontalTo(703.0f),
                        PathNode.QuadTo(693.0f, 485.0f, 687.0f, 479.5f),
                        PathNode.QuadTo(681.0f, 474.0f, 681.0f, 464.0f),
                        PathNode.VerticalTo(428.0f),
                        PathNode.QuadTo(681.0f, 418.0f, 687.0f, 412.0f),
                        PathNode.QuadTo(693.0f, 406.0f, 703.0f, 406.0f),
                        PathNode.HorizontalTo(786.0f),
                        PathNode.LineTo(727.0f, 351.0f),
                        PathNode.QuadTo(711.0f, 337.0f, 725.0f, 320.0f),
                        PathNode.LineTo(745.0f, 294.0f),
                        PathNode.QuadTo(757.0f, 279.0f, 772.0f, 287.0f),
                        PathNode.QuadTo(781.0f, 291.0f, 791.0f, 290.0f),
                        PathNode.QuadTo(811.0f, 289.0f, 822.0f, 278.5f),
                        PathNode.QuadTo(833.0f, 268.0f, 833.0f, 248.0f),
                        PathNode.QuadTo(833.0f, 229.0f, 821.5f, 218.0f),
                        PathNode.QuadTo(810.0f, 207.0f, 790.0f, 207.0f),
                        PathNode.QuadTo(762.0f, 207.0f, 744.0f, 233.0f),
                        PathNode.QuadTo(738.0f, 243.0f, 731.0f, 245.0f),
                        PathNode.QuadTo(724.0f, 247.0f, 715.0f, 241.0f),
                        PathNode.LineTo(685.0f, 221.0f),
                        PathNode.QuadTo(677.0f, 215.0f, 674.5f, 207.5f),
                        PathNode.QuadTo(672.0f, 200.0f, 677.0f, 192.0f),
                        PathNode.QuadTo(694.0f, 164.0f, 722.5f, 147.0f),
                        PathNode.QuadTo(751.0f, 130.0f, 791.0f, 130.0f),
                        PathNode.QuadTo(846.0f, 130.0f, 881.0f, 163.0f),
                        PathNode.QuadTo(916.0f, 196.0f, 916.0f, 248.0f),
                        PathNode.QuadTo(916.0f, 278.0f, 903.5f, 302.0f),
                        PathNode.QuadTo(891.0f, 326.0f, 870.0f, 339.0f),
                        PathNode.QuadTo(849.0f, 352.0f, 826.0f, 353.0f),
                        PathNode.Close,
                    ),
                    fill = SolidColor(Color.Black),
                    fillAlpha = 1f,
...
private var _th13Heavy: ImageVector? = null
