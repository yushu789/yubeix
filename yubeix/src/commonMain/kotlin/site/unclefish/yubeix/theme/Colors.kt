...
/**
 * The default color scheme for the Yubeix components.
 *
...
fun lightColorScheme(
    ...
    // Yubeix palette: background is the grouped page behind the cards, surface/surfaceContainer
    // are the cards themselves (cupertino: systemGroupedBackground vs secondarySystemBackground).
...
fun darkColorScheme(
    ...
    surfaceVariant: Color = Color(0xFF1C1C1E),
